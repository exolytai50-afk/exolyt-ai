...
//  ЗАГРУЗКА .ENV ФАЙЛА
// ============================================================
require_once dirname(__DIR__) . '/includes/env-loader.php';
...
// ============================================================
define('DB_HOST', getenv('DB_HOST') ?: '188.127.239.143');
...
//  БАЗОВЫЙ URL / ПУТИ
// ============================================================
define('SITE_URL', getenv('SITE_URL') ?: 'https://s1647298.smrtp.ru');
