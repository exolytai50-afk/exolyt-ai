<?php
/**
 * CookAI — анализ изображений через Qwen3.6-35B (VLM).
 */
declare(strict_types=1);
require_once __DIR__ . '/../config/config.php';

/**
 * Отправляет изображение (base64 без префикса) + промпт на Qwen3.6-35B, ожидает JSON-ответ.
 *
...
function yandex_vision_json(string $imageBase64, string $prompt, string $schema): array
{
    ...
    $body = [
        'modelUri' => 'gpt://' . YANDEX_FOLDER_ID . '/' . QWEN_3_6_MODEL,
        'completionOptions' => [
            'stream'      => false,
            'temperature' => 0.2,
            'maxTokens'   => 1500,
...
/** Низкоуровневый запрос к completion endpoint для Qwen3.6-35B */
